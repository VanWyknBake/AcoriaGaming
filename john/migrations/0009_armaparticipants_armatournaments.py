# Generated by Django 3.1.7 on 2021-08-02 16:30
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('john', '0008_mcparticipants_mctournaments'),
    ]

    operations = [
        migrations.CreateModel(
            name='ArmaTournaments',
            fields=[
        ...
        migrations.CreateModel(
            name='ArmaParticipants',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team_name', models.CharField(max_length=20)),
                ('tournament', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='john.armatournaments')),
            ],
        ),
    ]
